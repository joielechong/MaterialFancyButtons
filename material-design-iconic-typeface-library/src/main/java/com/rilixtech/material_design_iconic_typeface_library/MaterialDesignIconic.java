package com.rilixtech.material_design_iconic_typeface_library;
...
public class MaterialDesignIconic implements ITypeface {
    ...
    public static enum Icon implements IIcon {
        ...
        gmi_album('\uf104'),
        gmi_archive('\uf105'),
        gmi_assignmenti_account('\uf106'),
        gmi_assignmenti_alert('\uf107'),
        gmi_assignmenti_check('\uf108'),
        gmi_assignmenti_o('\uf109'),
        gmi_assignmenti_return('\uf10a'),
        gmi_assignmenti_returned('\uf10b'),
        gmi_assignment('\uf10c'),
        gmi_attachmenti_alt('\uf10d'),
        gmi_attachment('\uf10e'),
        gmi_audio('\uf10f'),
        ...
        gmi_format_indenti_decrease('\uf243'),
        gmi_format_indenti_increase('\uf244'),
        gmi_format_italic('\uf245'),
        ...
        gmi_wrap_text('\uf259'),
        gmi_commenti_alert('\uf25a'),
        gmi_commenti_alt_text('\uf25b'),
        gmi_commenti_alt('\uf25c'),
        gmi_commenti_edit('\uf25d'),
        gmi_commenti_image('\uf25e'),
        gmi_commenti_list('\uf25f'),
        gmi_commenti_more('\uf260'),
        gmi_commenti_outline('\uf261'),
        gmi_commenti_text_alt('\uf262'),
        gmi_commenti_text('\uf263'),
        gmi_commenti_video('\uf264'),
        gmi_comment('\uf265'),
        gmi_comments('\uf266'),
