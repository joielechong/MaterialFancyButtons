 ...
 */
package com.rilixtech.google_material_typeface_library;
...
public class GoogleMaterial implements ITypeface {
    ...
    public enum Icon implements IIcon {
        ...
        gmd_assignment('\ue85d'),
        gmd_assignmenti_ind('\ue85e'),
        gmd_assignmenti_late('\ue85f'),
        gmd_assignmenti_return('\ue860'),
        gmd_assignmenti_returned('\ue861'),
        gmd_assignmenti_turned_in('\ue862'),
        gmd_assistant('\ue39f'),
        gmd_assistant_photo('\ue3a0'),
        gmd_attach_file('\ue226'),
        gmd_attach_money('\ue227'),
        ...
        gmd_format_indenti_decrease('\ue23d'),
        gmd_format_indenti_increase('\ue23e'),
        gmd_format_italic('\ue23f'),
        ...
        gmd_select_all('\ue162'),
        gmd_send('\ue163'),
        gmd_sentimenti_dissatisfied('\ue811'),
        gmd_sentimenti_neutral('\ue812'),
        gmd_sentimenti_satisfied('\ue813'),
        gmd_sentimenti_very_dissatisfied('\ue814'),
        gmd_sentimenti_very_satisfied('\ue815'),
        gmd_settings('\ue8b8'),
        ...
        gmd_star_half('\ue839'),
        gmd_stars('\ue8d0'),
        gmd_stay_currenti_landscape('\ue0d3'),
        gmd_stay_currenti_portrait('\ue0d4'),
