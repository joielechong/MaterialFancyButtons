package com.example.mobirise_icons_parser;
...
public class MobiriseIconsParser {

  public static final String ICON_PREFIX = "mbri";

  public static void main(String[] args) {
    File file = new File("style.css");
    File outputFile = new File("mobirise_icons_output.txt");

    System.out.println("Starting parsing Mobirise Icons font");
